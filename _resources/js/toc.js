...
$(document).ready(function() {
  ...
  headers.on('click', function() {
    ...
    if (this_level === level) // same level as before; same indenting
      html += "<li><a href='#" + header.id + "' class=\"smooth-scroll\">" + header.innerHTML + "</a>";
    else if (this_level < level) // higher level than before; end parent ol
      html += "</li></ol></li><li><a href='#" + header.id + "' class=\"smooth-scroll\">" + header.innerHTML + "</a>";
    else if (this_level > level) // lower level than before; expand the previous to contain a ol
      html += "<ol><li><a href='#" + header.id + "' class=\"smooth-scroll\">" + header.innerHTML + "</a>";
  ...
  output.hide().html(html).show('fast');
});
